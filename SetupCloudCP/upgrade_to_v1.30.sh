...
# Kubernetes Control Plane Upgrade Script: v1.29 -> v1.30
# Run this script on the control plane node as root or with sudo

echo "=== Upgrading Kubernetes Control Plane: v1.29 → v1.30 ==="
...
# 2. Update apt repository to v1.30
echo "[2/6] Updating apt repository to v1.30..."
K8S_VERSION="1.30"
...
DEBIAN_FRONTEND=noninteractive apt-get install -y kubeadm=1.30.14-1.1
...
DEBIAN_FRONTEND=noninteractive apt-get install -y kubelet=1.30.14-1.1 kubectl=1.30.14-1.1
...
echo ""
echo "=== Upgrade to v1.30 Complete ==="
...
echo ""
echo "✓ Control plane successfully upgraded to v1.30.14"
